        ...
        const parsePayload = (payload) => {
            ...
            switch (hex2Dec(res.tipo)) {
                ...
                case 46:
                    ...
                    res.volumenDecilitros4 = payload.slice(72, 76);
                    res.distanciaLiquidomm5 = payload.slice(76, 80);
                    res.volumenDecilitros5 = payload.slice(84, 88);
                    res.distanciaLiquidomm6 = payload.slice(92, 96);
                    res.volumenDecilitros6 = payload.slice(96, 100);
                    res.distanciaLiquidomm7 = payload.slice(100, 104);
                    res.volumenDecilitros7 = payload.slice(104, 108);
                    res.distanciaLiquidomm8 = payload.slice(108, 112);
                    res.volumenDecilitros8 = payload.slice(112, 116);
                    res.distanciaLiquidomm9 = payload.slice(116, 120);
                    res.volumenDecilitros9 = payload.slice(120, 124);
                    res.distanciaLiquidomm10 = payload.slice(124, 128);
                    res.volumenDecilitros10 = payload.slice(128, 132);
                    res.distanciaLiquidomm11 = payload.slice(132, 136);
                    res.volumenDecilitros11 = payload.slice(136, 140);
                    break;
                case 80:
                    res.UTCE = payload.slice(0, 8);
                    res.semilla = payload.slice(8, 10);
